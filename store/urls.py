...
urlpatterns = [
    ...
    path('handle_product_search/', views.handle_product_search,
         name="handle_product_search"),
    path('view/<str:ptype>/<int:p_id>/<int:v_id>',
         views.product_view, name='product_view'),
    path('view/<str:ptype>/<int:p_id>', views.product_view, name='product_view'),
    path("selected_variant/<int:p_id>/<int:v_id>",
         views.selected_variant, name="selected_variant"),
    ...
    path("handle_cart_convert/", views.handle_cart_convert,
         name="handle_cart_convert"),
    path("select-address/", views.select_address, name='select_address'),
    path('ps/', views.print_session, name='print_session'),
    path('select_payment_gateway/', views.select_payment_gateway,
         name='select_payment_gateway'),
