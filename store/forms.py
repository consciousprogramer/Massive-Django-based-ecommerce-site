...
class CustomUserCreationForm(UserCreationForm):
    ...
    PhoneNumber = forms.CharField(label='Phone Number', max_length=11, min_length=10,
                                  help_text='10 Digit Phone Number', widget=forms.NumberInput())
...
class RegisterForm(forms.Form):
    Username = forms.CharField(
        label='Enter Username', help_text='You can use your Email or Phone number')
